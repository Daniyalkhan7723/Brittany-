...
@HiltViewModel
class SubscriptionPlanDetailViewModel @Inject constructor(
    ...
    var subscriptionSuccess: StateFlow<SubscriptionSuccessModel?> =
        _subscriptionSuccess

    private val TAG = SubscriptionPlanDetailViewModel::class.simpleName
        ...
        when (event) {
            is SubscriptionPlanUIEvent.SubscriptionSuccess -> {
                subscriptionUIState.value = subscriptionUIState.value.copy(
                    ...
                    expiryData = event.expiryData,
                    token = event.token,
                    packageId = event.packageId,
                    inAppResponse = event.inAppResponse
                )
